...
import com.Hello.re_grud.Alarm.ALARM
import com.Hello.re_grud.Calender.Pass
import com.Hello.re_grud.Donghwa.Donghwa
import com.Hello.re_grud.Education.Education
import com.Hello.re_grud.Login.Login
import com.Hello.re_grud.MemoryGame.Memory
import com.Hello.re_grud.Retro.RetroClient.Companion.prefs
import com.Hello.re_grud.Survey.Survey
...
*/
        ...
        main_pill.setOnClickListener{
            val intent = Intent(this, com.Hello.re_grud.Alarm.ALARM::class.java)//다음화면으로 이동하기위한 인텐트 객체생성
